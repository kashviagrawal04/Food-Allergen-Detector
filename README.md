...
(Adjust structure if your folder names differ — tell me if you want me to customize exactly.)

⚙️ How It Works

User uploads a food image

Image is preprocessed and passed to a ViT model

Model predicts the food category

The system checks the predicted category against a JSON allergen database

Displays potential allergen warnings
